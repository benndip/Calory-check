				...
				<form className="MyGoals__form" onSubmit={this.handleSubmit.bind(this)}>
					<span className="MyGoals__form--input">
						...
						<input
							...
							name="calories"
							placeholder="2300"
							value={this.state.goals.calories}
					...
					<span className="MyGoals__form--input">
						...
						<input
							...
							name="protein"
							placeholder="110 g"
							value={this.state.goals.protein}
							onChange={this.handleInputChange.bind(this)}
						/>
					</span>
					<span className="MyGoals__form--input">
					...
					{this.state.finishedSaving && (
						<span
							className="MyGoals__form--save-success animated fadeIn"

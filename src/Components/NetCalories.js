			...
			<div className="NetCalories">
				<span className="NetCalories__equation">
					<span className="NetCalories__number food">
						{new Intl.NumberFormat().format(this.props.caloriesEaten)}
					</span>
					<span className="NetCalories__label">Food Calories</span>
					<span className="NetCalories__minussign">-</span>
					<span className="NetCalories__number exercise">
						{this.props.caloriesBurned
							? new Intl.NumberFormat().format(this.props.caloriesBurned)
							: "0"}
					</span>
					<span className="NetCalories__label">Exercise Calories</span>
